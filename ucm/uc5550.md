...
# Overview
The UC5550 is a [UCM](intro.md) that supports the ST Microelectronics F4 (UC5550-P40) and F7 (UC5550-P80) processors with 16MB of external RAM. Depending on the SKU number, it can have a built-on ST Microelectronics WiFi module and/or an Ethernet PHY. It can also have 4MB of external flash for large user programs.

# Specifications
| Spec           | UC5550-P40                         | UC5550-P80                         |
|----------------|------------------------------------|------------------------------------|
| Processor      | ST STM32F413 32-bit ARM Cortex-M4  | ST STM32F767 32-bit ARM Cortex-M7  |
| Speed          | 180 MHz                            | 216 MHz                            |
| Internal RAM   | 256 KB (SRAM)                      | 512 KB (SRAM)                      |
| Internal Flash | 2 MB                               | 2 MB                               |
| External RAM   | 16 MB (SDRAM)                      | 16 MB (SDRAM)                      |
| External Flash | 0 KB                               | 4 MB (QSPI)                        |
